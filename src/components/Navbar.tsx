...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <div className="">
                <label className="hamburger-menu cursor-pointer m-2 z-20">
                ...
                <aside className={`bg-midnight text-beige mt-3 max-w-1/2 min-h-screen p-4 ${isChecked ? "animate-slide-in" : "animate-slide-out" }`}>
                    <nav className="">
