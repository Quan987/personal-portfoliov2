    ...
    return (
        <a href={data.link} target="_blank" rel="noopener noreferrer"
            ...
            <div>
                ...
                <h5 className="text-xl py-2">{data.title}</h5>
            </div>

            <ParagraphText text={data.description} className={"text-sm py-6 opacity-60 group-hover:opacity-100"}/>
            <div className={"mt-auto"}>
                <ul className="text-xs flex items-center gap-2 py-3 flex-wrap opacity-60 group-hover:opacity-100">
                ...
                {!data.isEmpty && (
                    <div
                       className="inline-flex justify-center font-bold items-center gap-1 active:text-white"
                       draggable={false}>
