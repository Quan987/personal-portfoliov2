...
export const PROJECTS = {
  ...
  carousel: [
    ...
    },
    {
      ...
      description:
        "A secure and user-friendly web application that generates strong, unique passwords and features a personal vault for safely storing and managing them with ease.",
    ...
    },
    {
      ...
      description:
        "A cross-platform chat app enabling real-time messaging and group chat rooms, powered by Firebase for authentication and fast, reliable data sync anytime, anywhere.",
